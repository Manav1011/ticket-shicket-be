...
## Corpus Check
- 150 files · ~155,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1161 nodes · 3510 edges · 65 communities detected
- Extraction: 40% EXTRACTED · 60% INFERRED · 0% AMBIGUOUS · INFERRED: 2104 edges (avg confidence: 0.5)
...
4. `EventModel` - 69 edges
5. `EventMediaAssetModel` - 68 edges
6. `EventAccessType` - 67 edges
7. `EventRepository` - 64 edges
8. `OrganizerService` - 63 edges
9. `OrganizerPageModel` - 59 edges
10. `BaseResponse` - 55 edges
...
Cohesion: 0.04
Nodes (125): Base, Base, A mixin class to add a primary key field in a model., Base class for defining database tables., A mixin class to add automatic timestamp fields.      Adds `created_at` and `upd, TimeStampMixin, UUIDPrimaryKeyMixin, BaseModel (+117 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (132): async_test_client(), auth_headers(), db_session(), guest_device_id(), invalid_file_type_bytes(), mock_s3_client(), oversized_image_bytes(), Create FastAPI app with mocked lifespan for HTTP testing. (+124 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (101): BaseResponse, CamelCaseModel, InviteType, OrganizerVisibility, InviteNotFound, InviteRepository, OrganizerRepository, UserRepository (+93 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (110): AlreadyExistsError, BadRequestError, Redis-based token blocklist for invalidating access tokens.  Uses a Redis SET to, Manages a Redis SET of blocked token JTIs., Add a jti to the blocklist.         Optionally set a TTL (in seconds) to auto-ex, Check if a jti is in the blocklist., Remove a jti from the blocklist (not typically needed)., TokenBlocklist (+102 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (27): Allocation app package., approve_b2b_request_free(), approve_b2b_request_paid(), confirm_b2b_payment(), convert_guest(), create_b2b_request(), delete_media_asset(), generate_device_id() (+19 more)
...
Cohesion: 0.08
Nodes (21): OrganizerService, Mock OrganizerService., Test that upload logo endpoint calls service method., Test that upload cover endpoint calls service method., service_mock(), test_upload_cover_endpoint_calls_service(), test_upload_logo_endpoint_calls_service(), organizer_service_mock() (+13 more)
...
Cohesion: 0.22
Nodes (7): create_tokens(), JWToken, JWT encoder/decoder. Handles access and refresh token types.     Does NOT handle, Encode payload into JWT token., Decode and validate JWT token., Create access-token and refresh-token.     Only one of user_id or guest_id shoul, SecurityBase
...
- **Why does `FileValidationError` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 7`, `Community 9`, `Community 19`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `EventService` connect `Community 1` to `Community 17`, `Community 2`, `Community 3`, `Community 5`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `EventRepository` connect `Community 5` to `Community 8`, `Community 1`, `Community 2`, `Community 0`?**
