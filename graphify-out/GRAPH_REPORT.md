...
## Corpus Check
- 165 files · ~156,172 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1220 nodes · 3521 edges · 74 communities detected
- Extraction: 41% EXTRACTED · 59% INFERRED · 0% AMBIGUOUS · INFERRED: 2070 edges (avg confidence: 0.5)
...
7. `OrganizerService` - 63 edges
8. `OrganizerPageModel` - 58 edges
9. `BaseResponse` - 55 edges
10. `EventRepository` - 55 edges
...
Cohesion: 0.04
Nodes (110): AlreadyExistsError, BadRequestError, CustomException, create_password(), decrypt(), Create a random password.      :return: A randomly generated password., Decrypts the given encrypted data.      :param rsa_key: The RSA private key., Exception (+102 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (87): BaseResponse, CamelCaseModel, InviteType, TicketCategoryPublic, InviteNotFound, InviteRepository, OrganizerRepository, AllocateTicketTypeRequest (+79 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (79): Base, Base, A mixin class to add a primary key field in a model., Base class for defining database tables., A mixin class to add automatic timestamp fields.      Adds `created_at` and `upd, TimeStampMixin, UUIDPrimaryKeyMixin, DeclarativeBase (+71 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (53): BaseModel, B2BRequestStatus, TicketCategory, TicketingRepository, ApproveB2BRequestFreeBody, ApproveB2BRequestPaidBody, CreateB2BRequestBody, RejectB2BRequestBody (+45 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (36): Redis-based token blocklist for invalidating access tokens.  Uses a Redis SET to, Manages a Redis SET of blocked token JTIs., Add a jti to the blocklist.         Optionally set a TTL (in seconds) to auto-ex, Check if a jti is in the blocklist., Remove a jti from the blocklist (not typically needed)., TokenBlocklist, GuestRepository, UserRepository (+28 more)
...
Cohesion: 0.03
Nodes (24): Allocation app package., approve_b2b_request_free(), approve_b2b_request_paid(), confirm_b2b_payment(), convert_guest(), create_b2b_request(), delete_media_asset(), generate_device_id() (+16 more)
...
Cohesion: 0.5
Nodes (1): drop b2b recipient fields  Revision ID: 6603c7296914 Revises: 0a32de8db265 Creat
...
## Knowledge Gaps
- **78 isolated node(s):** `Integration tests for Guest Module - Full Flow  These tests document the complet`, `Integration test covering complete guest lifecycle.      This test class documen`, `Step 1: Guest login creates guest record and returns tokens.          Expected:`, `Step 2: Guest protected endpoints require valid token.          Expected:`, `Step 3: Guest conversion creates User, links Guest, returns new tokens.` (+73 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 47`** (2 nodes): `test_event_reseller_model.py`, `test_event_reseller_model_creation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `test_invite_enums.py`, `test_invite_status_values()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `test_invite_models.py`, `test_invite_model_creation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `test_uuid_primary_key.py`, `test_uuid_primary_key_default_is_callable()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `test_model_registry.py`, `test_model_registry_loads_organizer_table()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 56`** (1 nodes): `Step 5: Guest logout revokes the refresh token.          Expected:         - POS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (1 nodes): `Validate the required fields for the application.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `Create a Database URL from the settings provided in the .env file.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `Check if the app is running in production mode.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `Check if the app is running in development mode.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Check if the app is running in local mode.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `model_registry.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `scheduler.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (1 nodes): `webhook.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `Validate banner image.          Args:             file_name: Original filename`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `Validate gallery image.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `Validate gallery video.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `Validate promo video URL.          Args:             url: Video URL (YouTube, Vi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (1 nodes): `Validate file extension against allowed types.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `Validate image dimensions.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `messages.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `regex.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `seeder.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `EventService` connect `Community 0` to `Community 8`, `Community 1`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `FileValidationError` connect `Community 0` to `Community 1`, `Community 2`, `Community 4`, `Community 15`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `OrganizerService` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Are the 91 inferred relationships involving `FileValidationError` (e.g. with `Create valid test image bytes (200x200 PNG).` and `Create small test image bytes (100x100 PNG).`) actually correct?**
  _`FileValidationError` has 91 INFERRED edges - model-reasoned connections that need verification._
- **Are the 54 inferred relationships involving `EventService` (e.g. with `Test that upload endpoint calls service method.` and `Test listing media assets returns list.`) actually correct?**
...
- **Are the 64 inferred relationships involving `EventModel` (e.g. with `Create valid test image (200x200 PNG) that passes validation.` and `Create valid test image (200x200 JPEG) that passes validation.`) actually correct?**
